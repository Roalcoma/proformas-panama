...
export class ClassExcelSalvador {
    
    static async excelSalvadorVSFA(dataToInsert: any, items: any, tipoExcel: string, workbook: any, worksheet: any, boldBorderStyle: any, outputDir: any, path: any): Promise<string> {
        let newFilePath: any = '';
        ...
        if (tipoExcel === 'BEAUTY') {
            ...
            items.forEach((item: any) => {
                ...
                cellB.value = item.DESCRIPCION_GENERAL;
                ...
                cellD.value = item.DETALLE_ADUANAL;
    ...
    static async excelSalvador(dataToInsert: any, items: any, tipoExcel: string, workbook: any, worksheet: any, boldBorderStyle: any, outputDir: any, path: any): Promise<string> {
        let newFilePath: any = '';
