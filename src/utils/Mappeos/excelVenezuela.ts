...
export class ClassExcelVenezuela {
    
    static async excelVenezuela(dataToInsert: any, items: any, tipoExcel: string, workbook: any, worksheet: any, boldBorderStyle: any, outputDir: any, path: any): Promise<string> {
        let newFilePath: any = '';
    ...
    static async excelVenezuelaVSFA(dataToInsert: any, items: any, tipoExcel: string, workbook: any, worksheet: any, boldBorderStyle: any, outputDir: any, path: any): Promise<string> {
        let newFilePath: any = '';

        if(tipoExcel === 'BEAUTY') {
            
            const clientCodeCell = worksheet.getCell('H7');
            ...
            const invoiceDateCell = worksheet.getCell('H3');
            invoiceDateCell.value = dataToInsert.invoiceDate;
            //invoiceDateCell.border = boldBorderStyle; // Aplicar borde
    
            const invoiceNumberCell = worksheet.getCell('H5');
            invoiceNumberCell.value = dataToInsert.invoiceNumber;
            //invoiceNumberCell.border = boldBorderStyle; // Aplicar borde
