...
export class ClassExcelCostaRica {
    
    static async excelCostaRica(dataToInsert: any, items: any, tipoExcel: string, workbook: any, worksheet: any, boldBorderStyle: any, outputDir: any, path: any): Promise<string> {
        let newFilePath: any = '';
        ...
        if (tipoExcel === 'BEAUTY') {
            ...
            items.forEach((item: any) => {
                ...
                cellC.value = item.REGISTRO_SANITARIO_CR;
    ...
    static async excelCostaRicaVSFA(dataToInsert: any, items: any, tipoExcel: string, workbook: any, worksheet: any, boldBorderStyle: any, outputDir: any, path: any): Promise<string> {
        ...
        if (tipoExcel === 'BEAUTY') {
            ...
            items.forEach((item: any) => {
                ...
                const cellF = worksheet.getCell(`F${currentRowForNewItems}`); cellF.value = item.FRAGANCIA ?? ''; cellF.border = boldBorderStyle;
